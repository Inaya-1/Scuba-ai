...
export const HUD: React.FC<HUDProps> = ({ state, compassAvailable = true }) => {
  return (
        ...
        <div className="glass-panel px-4 py-2 flex items-center gap-6">
          <div className="flex flex-col">
            ...
            <div className="flex items-baseline gap-1">
              <span className={`hud-value ${depthColor(state.depth)}`}>{state.depth.toFixed(1)}</span>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-baseline gap-1">
              <span className={`hud-value ${airColor(state.airPressure)}`}>
                {state.airPressure}
              </span>
